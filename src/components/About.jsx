      ...
      <div className="container mx-auto px-4 ">
        ...
        <div className="flex flex-wrap items-center justify-center">
          <motion.div
            ...
            viewport={{ once: true }}
            variants={aboutVariants}
            transition={{ duration: 2, delay: 0.7, ease: [0.25, 0.1, 0.25, 1] }}
          ...
          >
            ...
            >
              ...
              , a passionate front-end developer from Maharashtra, India. I
              specialize in building clean, responsive UIs with React, Tailwind,
              and a touch of animation. Currently, I'm actively seeking frontend
              opportunities while expanding my portfolio with real-world
              projects to demonstrate my problem-solving and technical skills.”{" "}
            </motion.p>
          </motion.div>
